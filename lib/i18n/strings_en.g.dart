...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  // Translations
  late final TranslationsMainScreenEn mainScreen =
      TranslationsMainScreenEn._(_root);
  Map<String, String> get locales => {
        'en': 'English',
        'fr': 'French',
      };
  String get notFound => 'Page Not Found';
  late final TranslationsHomeScreenEn home_screen =
      TranslationsHomeScreenEn._(_root);
}
...
class TranslationsHomeScreenEn {
  ...
  String get available => 'Available - authorized to work in Canada';
